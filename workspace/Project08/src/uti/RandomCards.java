...
public class RandomCards {
	...
	public static void main(String[] args) {
		...
		String[] deck = {"A clubs", "2 clubs", "3 clubs", "4 clubs", "5 clubs", "6 clubs", "7 clubs", "8 clubs", "9 clubs", "10 clubs", "J clubs", "Q clubs", "K clubs",
		...
		for(int i = 0; i < 4; i++) {
			...
			if(deck[randomIndex] != null) {
				System.out.println(deck[randomIndex]);
